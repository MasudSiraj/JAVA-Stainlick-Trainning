...
/*
* Trivera Farm application - Command - perform
* <p>
...
public class CommandPerform extends Command {

	public CommandPerform() {
		super();
	}

	public CommandPerform(String command) {
		super(command);
	}
	...
	public void execute(Object context) {
		...
		// prompt for behavior
		ctx.getPrintStream().println("Enter behavior: ");
		String behavior = ctx.getScanner().nextLine();
		if (behavior == null || behavior.equals("")) { return; }
		
		// ask animal to perform the behavior
